...
# FIXME: can we get rid of the eselect module?
RDEPEND="
...
src_configure() {
	local mycmakeargs=(
		...
		-DINSTALL_DIR_DATA="share/${P}/data"
		-DINSTALL_DIR_DOC="share/doc/${PF}"
		-DINSTALL_DIR_INCLUDE="include/${P}"
		-DINSTALL_DIR_LIB="$(get_libdir)/${P}"
		-DINSTALL_DIR_RESOURCE="share/${P}/resources"
		-DINSTALL_DIR_SAMPLES="share/${P}/samples"
		-DINSTALL_DIR_SCRIPT="$(get_libdir)/${P}/bin"
		# to avoid possible issues when the default is used during building
#		-DINSTALL_DIR_TESTS="share/${P}/tests"
...
pkg_postinst() {
	...
	ewarn "NOTE: This ebuild has not been tested for revdep compatibility."
	ewarn "There have been reported issue for at least freecad in their forum."
}
