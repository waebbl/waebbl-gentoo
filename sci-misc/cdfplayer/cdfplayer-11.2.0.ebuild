...
SRC_URI="CDFPlayer_11.1.1_LINUX.sh"
...
RDEPEND="
	...
	x11-libs/libxcb
	dev-libs/libxml2
	|| ( sys-libs/ncurses:5/5 sys-libs/ncurses:0/6 )
"
...
src_install() {
	...
	rm "${D}/opt/bin/"* || die
	dosym "${ROOT}/opt/Wolfram/CDFPlayer/${MPV}/Executables/wolframcdfplayer" "${ROOT}opt/bin/wolframcdfplayer"
	dosym "${ROOT}/opt/Wolfram/CDFPlayer/${MPV}/Executables/WolframCDFPlayer" "${ROOT}opt/bin/WolframCDFPlayer"
